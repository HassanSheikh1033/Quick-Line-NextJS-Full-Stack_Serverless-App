...
const page = () => {
  ...
  const handleDeleteService = async (serviceId: string) => {
    const confirmation = window.confirm(
     "Are you sure you want to delete this service? All associated tickets will also be deleted."
    )
    if (confirmation) {
      try {
    ...
    <Wrapper>
      <div className='flex w-full  flex-col md:flex-row'>
        <div className='space-y-2 md:w-1/4 w-full'>
          ...
          <span className='label-text'>Average time of the service</span>
        ...
        <div className='mt-4 md:mt-0 md:ml-4 md:w-3/4 md:border-l  border-base-200 md:pl-4 w-full'>
          <h3 className='font-semibold'>list of services</h3>
