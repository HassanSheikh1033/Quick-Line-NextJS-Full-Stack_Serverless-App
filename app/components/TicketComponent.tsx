...
const getStatusBadge = (status: string) => {
    switch (status) {
        case "IN_PROGRESS":
            return <div className='badge badge-primary'>Processing</div>
        case "PENDING":
            return <div className='badge badge-warning'>Pending</div>
        case "CALL":
            return <div className='badge badge-info'>It's your turn</div>
        case "FINISHED":
            return <div className='badge badge-success'>Served</div>
        default:
            return <div className='badge badge-primary'>Unknown status</div>
    }
}
        ...
        <div className='border p-5 border-base-300 rounded-xl flex flex-col space-y-2'>
            ...
            {ticket.status !== "IN_PROGRESS" && ticket.status !== "FINISHED" && (
                <div className='border border-base-300 rounded-xl p-5'>
                    <span className='badge badge-accent badge-outline'>Waiting</span>
                    <ul className="timeline timeline-vertical lg:timeline-horizontal w-full">

                        {totalWaitTime !== 0 && (
                            <li>
                                <div className="timeline-start">Estimated</div>
                        ...
                        <li>
                            <hr className={`${waitTimeStatus === "success" ? "bg-green-500" : "bg-red-500"}`} />
                            <div className="timeline-start">Real</div>
                            <div className="timeline-middle">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20"
